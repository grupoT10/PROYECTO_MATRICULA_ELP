...
import proyecto.pontificia.elp.mi.registromatricula.api.repository.Docenterepository;
...
public class Docentecontroller {
    ...
    @GetMapping("/lis")
    Page<Docente> index(@PageableDefault(sort = "coddocente", size = 5) Pageable pageable) {
